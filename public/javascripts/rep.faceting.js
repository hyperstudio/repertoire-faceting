...
(function($) {
  ...
  $.fn.facet_context = function(state_fn) {
    ...
    //
      ...
      $widget.addClass(options.spinner || 'spinner');
			$.ajax({
				url: url,
        ...
        complete: function () {
	        $widget.removeClass(options.spinner);
				}
      });
    };
    ...
    //
		...
		//
		// Render fetched html directly into widget
		//
    ...
    self.render = function(counts) {
      ...
      // title bar
      $value_list.append( '<div class="title">' + options.title + '<span class="controls"></span></div>' );
